...
private val vertices = arrayOf(
    ...
    TexturedVertex2(position = Vec2(x = 0.5f, y = -0.5f), color = Vec3(x = 0.0f, y = 1.0f, z = 0.0f)),
    TexturedVertex2(position = Vec2(x = 0.5f, y = 0.5f), color = Vec3(x = 0.0f, y = 0.0f, z = 1.0f)),
    TexturedVertex2(position = Vec2(x = -0.5f, y = 0.5f), color = Vec3(x = 1.0f, y = 1.0f, z = 1.0f)),
)
